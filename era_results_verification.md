...
Questo documento verifica la coerenza tra lo script (`run_era_implicit_gender_experiment.py`), i CSV prodotti dall'analisi, e i JSON di riepilogo (`era_summary.json`, `si_results.json`). Ogni numero è stato ricalcolato indipendentemente a partire dai dati grezzi.
