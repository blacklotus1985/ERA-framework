...
Numericamente la differenza è circa il 31\% in valore assoluto ($0.006$ vs $0.005$),
...
\paragraph{Perché 2.093 è grande.}
...
Un valore di $2.093$ corrisponde a un rapporto di probabilità tra i due gruppi
molto diverso tra $\M{0}$ e $\M{1}$.
Il fatto che il rapporto $L_2 / L_1 \approx 330$ indica che gli spostamenti avvengono
...
nelle rappresentazioni interne ci sono 122.292 unità di ridistribuzione probabilistica.
